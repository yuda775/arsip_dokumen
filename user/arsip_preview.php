                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                ...
                                if ($d['arsip_jenis'] == "png" || $d['arsip_jenis'] == "jpg" || $d['arsip_jenis'] == "gif" || $d['arsip_jenis'] == "jpeg") {
                                    $date = date('Y');
                                ?>
                                    <img src="../arsip/<?php echo $date . '/' . $d['arsip_file']; ?>">
                                <?php
                                } elseif ($d['arsip_jenis'] == "pdf") {
                                    $date = date('Y');
                                ?>
                                    <div class="pdf-singe-pro">
                                        <a class="media" href="../arsip/<?php echo $date . '/' . $d['arsip_file']; ?>"></a>
                                    </div>
                                <?php
                                } else {
                                    $date = date('Y');
                                ?>
                                    <p>Preview tidak tersedia, silahkan <a target="_blank" style="color: blue" href="../arsip/<?php echo $date . '/' . $d['arsip_file']; ?>">Download di sini.</a></p>
                                <?php
                                }
                                ?>
